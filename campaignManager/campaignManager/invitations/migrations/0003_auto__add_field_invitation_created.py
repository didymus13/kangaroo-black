...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invitation.created'
        db.add_column(u'invitations_invitation', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 7, 16, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invitation.created'
        db.delete_column(u'invitations_invitation', 'created')
