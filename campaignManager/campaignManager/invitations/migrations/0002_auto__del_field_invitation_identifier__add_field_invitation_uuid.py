...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Invitation.identifier'
        db.delete_column(u'invitations_invitation', 'identifier')

        # Adding field 'Invitation.uuid'
        db.add_column(u'invitations_invitation', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='aksdjh-askjdh-akjsdkjashd', max_length=254),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Invitation.identifier'
        db.add_column(u'invitations_invitation', 'identifier',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=254),
                      keep_default=False)

        # Deleting field 'Invitation.uuid'
        db.delete_column(u'invitations_invitation', 'uuid')
