...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.online_only'
        db.add_column(u'campaigns_campaign', 'online_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.online_only'
        db.delete_column(u'campaigns_campaign', 'online_only')
