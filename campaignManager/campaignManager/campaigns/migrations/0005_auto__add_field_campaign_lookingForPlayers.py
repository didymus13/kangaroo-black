...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.lookingForPlayers'
        db.add_column(u'campaigns_campaign', 'lookingForPlayers',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.lookingForPlayers'
        db.delete_column(u'campaigns_campaign', 'lookingForPlayers')
    ...
    models = {
        ...
        u'campaigns.campaign': {
            ...
            'lookingForPlayers': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'moderator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['profiles.Profile']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'turn': ('django.db.models.fields.CharField', [], {'default': '1', 'max_length': '64', 'blank': 'True'})
        },
