...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.game'
        db.add_column(u'campaigns_campaign', 'game',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['armies.Game']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.game'
        db.delete_column(u'campaigns_campaign', 'game_id')
    ...
    models = {
        ...
        u'campaigns.campaign': {
            ...
            'armies': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['armies.Army']", 'symmetrical': 'False', 'blank': 'True'}),
            'blurb': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
