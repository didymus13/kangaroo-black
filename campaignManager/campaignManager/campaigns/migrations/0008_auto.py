...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field participants on 'Campaign'
        m2m_table_name = db.shorten_name(u'campaigns_campaign_participants')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('campaign', models.ForeignKey(orm[u'campaigns.campaign'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['campaign_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field participants on 'Campaign'
        db.delete_table(db.shorten_name(u'campaigns_campaign_participants'))
    ...
    models = {
        ...
        u'campaigns.campaign': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'participants': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'Participant'", 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
