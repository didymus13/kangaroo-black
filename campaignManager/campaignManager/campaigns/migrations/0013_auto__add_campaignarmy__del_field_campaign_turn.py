...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CampaignArmy'
        db.create_table(u'campaigns_campaignarmy', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('army', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['armies.Army'], unique=True)),
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campaigns.Campaign'])),
            ('campaign_points', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('victory_points', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('currency', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'campaigns', ['CampaignArmy'])

        # Deleting field 'Campaign.turn'
        db.delete_column(u'campaigns_campaign', 'turn')


    def backwards(self, orm):
        # Deleting model 'CampaignArmy'
        db.delete_table(u'campaigns_campaignarmy')

        # Adding field 'Campaign.turn'
        db.add_column(u'campaigns_campaign', 'turn',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=64, blank=True),
                      keep_default=False)
    ...
    models = {
        u'armies.army': {
            ...
            'draw': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
