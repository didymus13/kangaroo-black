    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(default=0, choices=[(0, b'setting up'), (100, b'looking for players'), (300, b'playing'), (500, b'finished'), (600, b'on hiatus')])),
                ('photo', models.ImageField(null=True, upload_to=b'photos/%Y/%m/%d', blank=True)),
                ('game', models.ForeignKey(to='armies.Game')),
                ('moderator', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
                ('participants', models.ManyToManyField(related_name=b'Participant', to=settings.AUTH_USER_MODEL, blank=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('army', models.OneToOneField(to='armies.Army')),
