...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'campaigns_campaign', 'location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'Campaign.country'
        db.add_column(u'campaigns_campaign', 'country',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'campaigns_campaign', 'location')

        # Deleting field 'Campaign.country'
        db.delete_column(u'campaigns_campaign', 'country')
