...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Campaign.moderator'
        db.alter_column(u'campaigns_campaign', 'moderator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Profile']))

    def backwards(self, orm):

        # Changing field 'Campaign.moderator'
        db.alter_column(u'campaigns_campaign', 'moderator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['default.UserSocialAuth']))
