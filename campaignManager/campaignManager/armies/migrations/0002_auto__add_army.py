...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Army'
        db.create_table(u'armies_army', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['default.UserSocialAuth'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('faction', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('blurb', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('armylist', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'armies', ['Army'])


    def backwards(self, orm):
        # Deleting model 'Army'
        db.delete_table(u'armies_army')
