...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Faction.photo'
        db.add_column(u'armies_faction', 'photo',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Game.photo'
        db.add_column(u'armies_game', 'photo',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Army.photo'
        db.add_column(u'armies_army', 'photo',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Faction.photo'
        db.delete_column(u'armies_faction', 'photo')

        # Deleting field 'Game.photo'
        db.delete_column(u'armies_game', 'photo')

        # Deleting field 'Army.photo'
        db.delete_column(u'armies_army', 'photo')
