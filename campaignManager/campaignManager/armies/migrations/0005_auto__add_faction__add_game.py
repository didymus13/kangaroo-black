...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'armies_faction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['armies.Game'])),
        ))
        db.send_create_signal(u'armies', ['Faction'])

        # Adding model 'Game'
        db.create_table(u'armies_game', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal(u'armies', ['Game'])


    def backwards(self, orm):
        # Deleting model 'Faction'
        db.delete_table(u'armies_faction')

        # Deleting model 'Game'
        db.delete_table(u'armies_game')
