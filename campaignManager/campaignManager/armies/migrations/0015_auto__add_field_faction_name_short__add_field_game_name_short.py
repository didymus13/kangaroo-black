...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Faction.name_short'
        db.add_column(u'armies_faction', 'name_short',
                      self.gf('django.db.models.fields.CharField')(default='new', max_length=4),
                      keep_default=False)

        # Adding field 'Game.name_short'
        db.add_column(u'armies_game', 'name_short',
                      self.gf('django.db.models.fields.CharField')(default='new', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Faction.name_short'
        db.delete_column(u'armies_faction', 'name_short')

        # Deleting field 'Game.name_short'
        db.delete_column(u'armies_game', 'name_short')
