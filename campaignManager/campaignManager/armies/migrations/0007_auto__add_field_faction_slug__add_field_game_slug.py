...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Faction.slug'
        db.add_column(u'armies_faction', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'Game.slug'
        db.add_column(u'armies_game', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Faction.slug'
        db.delete_column(u'armies_faction', 'slug')

        # Deleting field 'Game.slug'
        db.delete_column(u'armies_game', 'slug')
