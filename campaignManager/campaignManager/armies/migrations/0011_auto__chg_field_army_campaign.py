...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Army.campaign'
        db.alter_column(u'armies_army', 'campaign_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campaigns.Campaign'], null=True))

    def backwards(self, orm):

        # Changing field 'Army.campaign'
        db.alter_column(u'armies_army', 'campaign_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['campaigns.Campaign']))
