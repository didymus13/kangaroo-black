...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'armies_army', 'faction_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['armies.Faction'], null=True))

    def backwards(self, orm):

        # Changing field 'Army.faction'
        db.alter_column(u'armies_army', 'faction_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['armies.Faction']))
