...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Army.user'
        db.alter_column(u'armies_army', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Profile']))

    def backwards(self, orm):

        # Changing field 'Army.user'
        db.alter_column(u'armies_army', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['default.UserSocialAuth']))
