...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Army.campaign'
        db.add_column(u'armies_army', 'campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['campaigns.Campaign'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Army.campaign'
        db.delete_column(u'armies_army', 'campaign_id')
    ...
    models = {
        u'armies.army': {
            ...
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['campaigns.Campaign']", 'blank': 'True'}),
