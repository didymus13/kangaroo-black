...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Turn'
        db.create_table(u'turns_turn', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('progression', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ...
        db.send_create_signal(u'turns', ['Turn'])


    def backwards(self, orm):
        # Deleting model 'Turn'
        db.delete_table(u'turns_turn')
    ...
    models = {
        ...
        u'turns.turn': {
            'Meta': {'ordering': "['-progression', '-created']", 'object_name': 'Turn'},
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['campaigns.Campaign']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'progression': ('django.db.models.fields.IntegerField', [], {'default': '1'})
        }
    }
