...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'turns_challenge', (
            ...
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('winner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='winner', to=orm['campaigns.CampaignArmy'], blank=True)),
