...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'turns_challenge', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('turn', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['turns.Turn'])),
            ('winner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='winner', blank=True, to=orm['campaigns.CampaignArmy'])),
            ('status', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'turns', ['Challenge'])

        # Adding M2M table for field participants on 'Challenge'
        m2m_table_name = db.shorten_name(u'turns_challenge_participants')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('challenge', models.ForeignKey(orm[u'turns.challenge'], null=False)),
            ('campaignarmy', models.ForeignKey(orm[u'campaigns.campaignarmy'], null=False))
        ))
        db.create_unique(m2m_table_name, ['challenge_id', 'campaignarmy_id'])

        # Deleting field 'Turn.progression'
        db.delete_column(u'turns_turn', 'progression')


    def backwards(self, orm):
        # Deleting model 'Challenge'
        db.delete_table(u'turns_challenge')

        # Removing M2M table for field participants on 'Challenge'
        db.delete_table(db.shorten_name(u'turns_challenge_participants'))

        # Adding field 'Turn.progression'
        db.add_column(u'turns_turn', 'progression',
